...
│                                                               │
│   Program A  ──┐                                             │
│   Program B  ──┼──→  -O3  ──→  Same passes for all programs │
│   Program C  ──┘                                             │
│                                                               │
│   ⚠️  Suboptimal for many programs!                          │
└─────────────────────────────────────────────────────────────┘
...
├─────────────────────────────────────────────────────────────┤
│                                                               │
│   Program A  ──→  ML Model  ──→  Custom Pass Sequence A      │
│   Program B  ──→  ML Model  ──→  Custom Pass Sequence B      │
│   Program C  ──→  ML Model  ──→  Custom Pass Sequence C      │
│                                                               │
│   ✨ Optimized for each program's unique characteristics!    │
└─────────────────────────────────────────────────────────────┘
```
...
│                                                                  │
│  ┌──────────────┐      ┌──────────────┐      ┌──────────────┐ │
│  │   235+ C     │      │   Generate   │      │   Measure    │ │
│  │  Programs    │ ───► │  600 Pass    │ ───► │ Performance  │ │
│  │              │      │  Sequences   │      │  & Size      │ │
│  └──────────────┘      └──────────────┘      └──────────────┘ │
│         │                                            │          │
│         │                                            │          │
...
│                                                                  │
│  ┌──────────────┐      ┌──────────────┐      ┌──────────────┐ │
│  │  Training    │      │   XGBoost    │      │  Transformer │ │
│  │    Data      │ ───► │    Model     │ ───► │    Model     │ │
│  │  (5K-6K pts) │      │ (Base Pred.) │      │ (Sequences)  │ │
│  └──────────────┘      └──────────────┘      └──────────────┘ │
│                                                       │          │
│                                                       │          │
│                                                       ▼          │
